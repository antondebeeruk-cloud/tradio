      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm leading-6 text-slate-500">
            Take a photo or upload an image/PDF. Save it first, then use Scan
            file on the saved receipt so Tradio can read it in the background.
          </p>
        </div>
